# Cultural Ontology Source Manifest

Created: 2026-06-09

This manifest records sources gathered for
`docs/cultural-ontology-meta-analysis.tex`. Open PDFs are cached when available.
Books, corpus sites, documentation pages, and unavailable PDFs are recorded as
live references.

## Cached PDFs

Files live under `docs/research/cultural-ontology/sources/pdfs/`.

| File | Bytes | SHA-256 | Source URL | Use |
| --- | ---: | --- | --- | --- |
...
| `lajar-2024-japanese-ryukyuan-atlas.pdf` | 97933 | `f112a35724ea51af583babea03b190bc57e91febb132bdc1fd46bb502d8c10dd` | https://aclanthology.org/2024.sigtyp-1.7.pdf | Japanese/Ryukyuan typology database. |
...
- Slobin, Dan I. 1996. `From "thought and language" to "thinking for speaking"`.
  In `Rethinking Linguistic Relativity`. Book chapter; no open standalone PDF
  cached.
- Lucy, John A. 1992. `Language Diversity and Thought`. Book; no open PDF
  cached.
- Gumperz, John J., and Stephen C. Levinson, eds. 1996.
  `Rethinking Linguistic Relativity`. Book; no open PDF cached.
- Green, Lisa J. 2002. `African American English: A Linguistic Introduction`.
  Book; no open PDF cached.
- Rickford, John R. 1999. `African American Vernacular English: Features,
  Evolution, Educational Implications`. Book; no open PDF cached.
- Rickford, John R. 2016. `Labov's contributions to the study of African
  American Vernacular English`. DOI: https://doi.org/10.1111/josl.12198.
- Yale Grammatical Diversity Project, `Invariant be`:
...
- Scots Syntax Atlas data page:
  https://scotssyntaxatlas.ac.uk/about/about-the-data/.
- Dictionaries of the Scots Language:
  https://dsl.ac.uk/our-publications/what-is-dsl/.
- Highland English reference:
  https://www.encyclopedia.com/humanities/encyclopedias-almanacs-transcripts-and-maps/highland-english.
- Projeto SP2010 corpus:
  https://projetosp2010.fflch.usp.br/corpus.
- Mineiro dialect/history source:
  https://periodicos.uff.br/gragoata/article/view/33374.
- Mineiro variation source record:
  https://sumarios.org/artigo/varia%C3%A7%C3%A3o-lingu%C3%ADstica-do-%E2%80%9Cmineir%C3%AAs%E2%80%9D-tra%C3%A7os-fon%C3%A9tico-fonol%C3%B3gicos-morfossint%C3%A1ticos-lexicais-e.
- NINJAL COJADS:
  https://www2.ninjal.ac.jp/cojads/index.html.
- NINJAL Corpus of Historical Japanese:
  https://clrd.ninjal.ac.jp/chj/overview-en.html.
- ONCOJ:
  https://oncoj.ninjal.ac.jp/.
- Qdrant filtering docs:
  https://qdrant.tech/documentation/search/filtering/.
- Qdrant vector-search filtering article:
  https://qdrant.tech/articles/vector-search-filtering/.

## Failed Or Partial PDF Retrievals

- Nature hosted PDF for Hofmann et al. returned HTML. Cached the arXiv preprint
  instead and kept the Nature DOI in the TeX bibliography.
- NINJAL repository PDF `About_Dialect_Discourse_Data.pdf` returned HTTP 502.
- NINJAL repository PDF `lrec2018sss_kibe.pdf` returned HTTP 502.
