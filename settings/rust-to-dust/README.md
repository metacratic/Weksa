...
Rust to Dust is Weksa's first proving ground.
...
- [Setting](./setting.md): premise, empire, cultural contamination.
- [Aliens](./aliens.md): species and values. Names remain unresolved.
- [Story](./story.md): single-player father arc.
- [Battle Royale](./battle-royale.md): controlled combat spectacle and broadcast
  surface.
